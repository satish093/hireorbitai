  ...
  return createPortal(
    ...
    >
      <div
        ref={dialogRef}
        tabIndex={-1}
        className={`bg-surface rounded-2xl shadow-2xl ring-1 ring-slate-900/5 w-full ${SIZE_CLASS[size]} flex flex-col max-h-[calc(100dvh-1.5rem)] sm:max-h-[calc(100dvh-3rem)] overflow-hidden animate-scale-in focus:outline-none`}
