...
export function SourcesDrawer({
  ...
  return (
    <Drawer
      open
      onClose={onClose}
      title="Live job sources"
      description="Pull real-time listings from legitimate public APIs."
    >
      {/* Add new source */}
      ...
      {!loading && health.length > 0 && (
        <div className="-mx-5 px-5 py-4 border-b border-border mb-5">
      ...
      {loading ? (
        ...
        <div className="-mx-5 divide-y divide-border">
          {rows.length === 0 && (
            <div className="px-5 py-6 text-sm text-muted italic text-center">
