      ...
      >
        <div className="px-6 pt-6 pb-4 flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-base font-semibold text-ink">Already submitted</h2>
            <p className="text-sm text-muted mt-1 leading-relaxed">
              <strong>{consultantName}</strong> has already been submitted to{' '}
              <strong className="text-ink">{jobTitle}</strong>.
            </p>
        ...
        <p className="px-6 pb-5 text-xs text-muted leading-relaxed">
        ...
        <div className="px-6 py-3 border-t border-border bg-hover flex items-center justify-end gap-2">
          <button
            onClick={onCancel}
            className="border border-border text-ink text-sm font-medium px-4 py-2 rounded-lg hover:bg-surface"
          >
            Cancel
          </button>
          <button
