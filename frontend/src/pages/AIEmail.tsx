    ...
    <Layout title="AI Vendor Email">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
        ...
        <div className="lg:col-span-2 bg-white border border-slate-200 rounded-xl p-5 space-y-3 h-fit">
          ...
          <div className="text-[10px] font-semibold uppercase tracking-widest text-slate-500 mt-3 mb-1">
            Consultant
          </div>
          <FormInput
        ...
        <div className="lg:col-span-3 bg-white border border-slate-200 rounded-xl p-5 min-h-[400px] flex flex-col">
          {out ? (
            <>
              ...
              <pre className="whitespace-pre-wrap break-words text-sm text-slate-800 font-sans leading-relaxed flex-1">
                {out.body}
              </pre>
            </>
          ) : (
            <div className="flex-1 flex flex-col items-center justify-center text-center text-slate-400">
              ...
              <p className="text-sm">
                ...
                <span className="font-medium text-slate-600">Generate email</span>.
              </p>
